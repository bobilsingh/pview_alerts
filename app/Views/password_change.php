...
<p class="text-muted mb-4">
  <?php if ($forcedFlag) { ?>
    Your password is older than <?= (int) $rotateDays; ?> days. For security, please set a new one to continue using
    <?= esc($appName); ?>.
  <?php } else { ?>
...
<form action="<?= site_url('password/change'); ?>" method="post" autocomplete="off" data-loading-form="1">
  ...
  <div class="input-group mb-3">
    ...
    <input type="password" name="current_password" id="currentPassword" class="form-control" required autofocus
      data-caps-warn="1">
    <button type="button" class="btn btn-outline-secondary" data-toggle-password="currentPassword" tabindex="-1"
  ...
  <div class="input-group mb-3">
    ...
    <input type="password" name="new_password" id="newPassword" class="form-control" required data-caps-warn="1"
      minlength="8">
    <button type="button" class="btn btn-outline-secondary" data-toggle-password="newPassword" tabindex="-1"
  ...
  <div class="input-group mb-4">
    ...
    <input type="password" name="confirm_password" id="confirmPassword" class="form-control" required data-caps-warn="1"
      minlength="8">
    <button type="button" class="btn btn-outline-secondary" data-toggle-password="confirmPassword" tabindex="-1"
      title="Show / hide password">
      <i class="bi bi-eye"></i>
    </button>
  </div>
