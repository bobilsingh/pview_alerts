...
<form method="post" action="<?= site_url('me/dashboard'); ?>" data-loading-form="1">
  <div class="card mb-3">
    ...
    <div class="card-body">
      <p class="text-muted small mb-2">When set, the dashboard KPIs, severity mix and trend chart will be scoped to this
        project on page load. Pick <em>All projects</em> to keep the broader view.</p>
  ...
  <div class="card mb-3">
    ...
    <div class="card-body">
      <p class="text-muted small mb-3">Uncheck any card you don't want to see. At least one card stays visible
        automatically.</p>
      <div class="row g-3">
        <div class="col-md-3">
          <div class="form-check form-switch">
            <input type="checkbox" class="form-check-input" name="kpi_open" id="kpi_open" <?php if ($kpiVisible['open'] === 1) {
              echo 'checked';
            } ?>>
        ...
        <div class="col-md-3">
          <div class="form-check form-switch">
            <input type="checkbox" class="form-check-input" name="kpi_critical" id="kpi_critical" <?php if ($kpiVisible['critical'] === 1) {
              echo 'checked';
            } ?>>
        ...
        <div class="col-md-3">
          <div class="form-check form-switch">
            <input type="checkbox" class="form-check-input" name="kpi_major" id="kpi_major" <?php if ($kpiVisible['major'] === 1) {
              echo 'checked';
            } ?>>
        ...
        <div class="col-md-3">
          <div class="form-check form-switch">
            <input type="checkbox" class="form-check-input" name="kpi_resolved" id="kpi_resolved" <?php if ($kpiVisible['resolved'] === 1) {
              echo 'checked';
            } ?>>
  ...
  <div class="card mb-3">
    ...
    <div class="card-body">
      <p class="text-muted small mb-2">Which time window the Ticket Trend chart opens at. You can still switch via the
        7/15/30 picker on the dashboard.</p>
